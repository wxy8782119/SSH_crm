											...
											<TBODY>
												<TR>
													...
													<TD>
														...
														style="WIDTH: 80px" maxLength=50 name="lkm_name" value="${param.lkm_name}"><!-- ${param['lkm_name'] } -->
													</TD>
													<TD>客户名称：</TD>
													<TD>
														...
														<input type="button" value="选择客户" onclick="window.open('${pageContext.request.contextPath }/CustomerAction_list?select=true','','width=600,height=280')" />
													</TD>
